...
-- L0048@000D.  opr2 = 0b10, val6 = 0b00111111 & @ H;
--  opr2 = 10, val6 = 010101;
13 => "10" & O"25",

-- L0049@000E.  opr2 = 0b10, val6 = 0b00111111 & @ E;
--  opr2 = 10, val6 = 010110;
14 => "10" & O"26",

-- L0050@000F.  opr2 = 0b10, val6 = 0b00111111 & @ L;
--  opr2 = 10, val6 = 010111;
15 => "10" & O"27",
...
-- L0052@0011.  opr2 = 0b10, val6 = 0b00111111 & @ O;
--  opr2 = 10, val6 = 011000;
17 => "10" & O"30",

-- L0053@0012.  opr2 = 0b10, val6 = 0b00111111 & @ SPACE;
--  opr2 = 10, val6 = 100101;
18 => "10" & O"45",

-- L0054@0013.  opr2 = 0b10, val6 = 0b00111111 & @ W;
--  opr2 = 10, val6 = 011101;
19 => "10" & O"35",

-- L0055@0014.  opr2 = 0b10, val6 = 0b00111111 & @ O;
--  opr2 = 10, val6 = 011000;
20 => "10" & O"30",

-- L0056@0015.  opr2 = 0b10, val6 = 0b00111111 & @ R;
--  opr2 = 10, val6 = 011110;
21 => "10" & O"36",

-- L0057@0016.  opr2 = 0b10, val6 = 0b00111111 & @ L;
--  opr2 = 10, val6 = 010111;
22 => "10" & O"27",

-- L0058@0017.  opr2 = 0b10, val6 = 0b00111111 & @ D;
--  opr2 = 10, val6 = 011001;
23 => "10" & O"31",

-- L0059@0018.  opr2 = 0b10, val6 = 0b00111111 & @ EXCPOINT;
--  opr2 = 10, val6 = 100110;
24 => "10" & O"46",

-- L0060@0019.  opr2 = 0b10, val6 = 0b00111111 & @ CRLF;
--  opr2 = 10, val6 = 001100;
25 => "10" & O"14",

-- L0062@001A.DISPLOOP:  opr2 = 0b10, val6 = 0b00111111 & @ DISP_LED;
--  opr2 = 10, val6 = 001010;
26 => "10" & O"12",

-- L0063@001B.  opr8 = 0x07;
--  opr8 = 00000111;
27 => X"07",

-- L0064@001C.  opr2 = 0b11, val6 = 0b00111111 & @ DISPLOOP;
--  opr2 = 11, val6 = 011010;
28 => "11" & O"32",

-- L0065@001D.  opr6 = 0b010001, val2 = 0b00;
--  opr6 = 010001, val2 = 00;
29 => O"21" & "00",

-- L0066@001E.  opr2 = 0b10, val6 = 0b00111111 & @ ROTATE;
--  opr2 = 10, val6 = 000000;
30 => "10" & O"00",

-- L0067@001F.  opr6 = 0b010001, val2 = 0b01;
--  opr6 = 010001, val2 = 01;
31 => O"21" & "01",

-- L0068@0020.  opr2 = 0b10, val6 = 0b00111111 & @ ROTATE;
--  opr2 = 10, val6 = 000000;
32 => "10" & O"00",

-- L0069@0021.  opr2 = 0b11, val6 = 0b00111111 & @ GREETINGS;
--  opr2 = 11, val6 = 001100;
33 => "11" & O"14",
...
-- 867 location(s) in following ranges will be filled with default value
-- 0022 .. 033F
-- 0376 .. 037F
-- 038F .. 03BF
-- 03F6 .. 03FF
